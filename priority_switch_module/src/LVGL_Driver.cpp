...
void Lvgl_Init(void)
{
  ...
  disp_drv.sw_rotate = 1;                       // Enable LVGL's software rotation feature
  disp_drv.draw_buf = &draw_buf;
  lv_disp_drv_register( &disp_drv );

  /* Register the display driver and capture the return value into a pointer */
  lv_disp_t *disp = lv_disp_drv_register(&disp_drv);

  /* Set the rotation (90 degrees) */
